...
- **IaaS (Infraestructura como Servicio):** Ofrece servidores, redes, máquinas virtuales y almacenamiento.
...
- **Nube Pública:** Administración por un proveedor externo. Acceso por suscripción (ej. AWS, Azure).
- **Nube Privada:** Infraestructura dedicada a una organización específica.
